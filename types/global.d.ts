...
declare global {
	...
	enum SchemaColumnDataType {
		...
		Memo = 'memo',
		Link = 'schemaLink',
		//CustomDirective = <any>'customDirective',
		//SystemType = <any>'systemType',
		UrlLink = 'urlLink',
		StringMonthWeek = 'stringMonthWeek',
		Chips = 'chips',
		//CalculatedField = <any>'calculatedField',
		Markdown = 'markdown',
		//MoneyWithCurrency = <any>'moneyWithCurrency',
		Percentage = 'percentage',
		//ButtonForm = <any>'buttonForm',
		//List = <any>'list',
		//FreeHtmlInput = <any>'freeHtmlInput'
	}
	...
	interface IDooApiTableCompany {
			 ...
			 * Roles
			 */
			role?: IDooApiLinkToMany<IDooApiTypeLinkToManyRole>;
			/**
			 * Company
			 */
			...
			companyAutocomplete?: any;
				...
				interface IDooApiTypeLinkToManyRole {
			 ...
			 * Users
			 */
			users?: IDooApiLinkToManyFieldsGeneric;
			/**
			 * Description
			 */
			x8ddszd82t?: IDooApiLinkToManyFieldsGeneric;
			}
	...
	interface IDoo {
	tableAutocomplete: ITabidooAutocomplete;
	...
	*/
	...
	filter?: string | IPublicApiFilter;
	limit?: number;
	}


	interface IDooGetDataOption<T> {
	filter?: string | IPublicApiFilter | T;
	sort?: string;
	limit?: number;
	skip?: number;
	loadFields?: string[];
	 ...
	 */
	getData?<T>(tableNameOrId: string, options?: IDooGetDataOption<any>, applicationId?: string): Promise<IDooGetDataResponse<T>>;
	/**
	 ...
	 */
	getCount?(tableNameOrId: string, options?: IDooGetDataOption<any>, applicationId?: string): Promise<IDooGetCountResponse>;
	/**
	 ...
	 * @param options 
	 */
	getLinkedRecordsV2?<T>(tableNameOrId: string, recordId, fieldName, options?: IDooGetDataOption<any>): Promise<IDooGetDataResponse<T>>;
	/**
